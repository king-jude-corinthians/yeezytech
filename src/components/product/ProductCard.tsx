      ...
      <Link href={`/product/${product.slug}`} className="block">
        ...
        >
          ...
          <div className="relative aspect-[4/3] bg-slate-50 overflow-hidden">
            ...
            {/* Badges */}
            {product.isNew && (
              <span className="absolute top-3 left-3 bg-[#000435] text-white text-[10px] font-semibold px-2.5 py-1 rounded-full tracking-wide">
                New
              </span>
            )}
          ...
          <div className="p-4">
            ...
            <motion.button
              ...
              className="mt-3 w-full bg-[#000435] text-white text-sm font-medium py-2.5 rounded-xl flex items-center justify-center gap-2 hover:bg-[#000328] active:scale-[0.98] transition-all md:flex hidden"
            >
              <ShoppingBag size={14} />
              Add to Cart
            </motion.button>
            <button
              onClick={handleAddToCart}
              className="mt-3 w-full bg-[#000435] text-white text-sm font-medium py-2.5 rounded-xl flex items-center justify-center gap-2 hover:bg-[#000328] active:scale-[0.98] transition-all md:hidden"
            >
              <ShoppingBag size={14} />
              Add to Cart
            </button>
