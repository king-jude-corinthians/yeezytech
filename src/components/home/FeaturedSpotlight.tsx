        ...
        >
          ...
          <div className="p-10 md:p-14 flex flex-col justify-center">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 bg-zinc-900 text-white rounded-xl px-7 py-4 font-medium hover:bg-zinc-800 active:scale-[0.98] transition-all w-fit"
            >
              View Details
              <ArrowRight size={16} />
            </Link>
